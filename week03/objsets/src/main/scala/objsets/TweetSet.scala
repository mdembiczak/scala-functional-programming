...
class Empty extends TweetSet:
  ...
  override def descendingByRetweet: _root_.objsets.TweetList = Nil

  override def mostRetweeted: Tweet = throw NoSuchFieldException()
...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet:
  ...
  override def descendingByRetweet: _root_.objsets.TweetList =
...
object GoogleVsApple:
  ...
  lazy val googleTweets: TweetSet = findSpecificTweets(google)
  lazy val appleTweets: TweetSet = findSpecificTweets(apple)

  private def findSpecificTweets(list: List[String]) = TweetReader.allTweets
      .filter(tweet => list.exists(str => tweet.text.contains(str)))
